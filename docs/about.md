...
### Carlos Pocasangre
I am a researcher and professor in Renewable Energy and Energy Efficiency in Buildings, with a strong background in electrical engineering and geophysics. He currently heads the Telecommunications Department at the School of Electrical Engineering at the University of El Salvador. He holds a PhD in Geophysical Engineering from Kyushu University, Japan, and a Master's degree in Renewable Energy from the University of León, Nicaragua. His extensive experience includes research in geothermal resources, energy efficiency in buildings, and the use of remote sensing for environmental monitoring. As a Senior Member of IEEE and a member of the Geosciences and Remote Sensing Society (GRSS), he has led several innovative projects, such as SICUES for mapping geothermal potential in El Salvador and power quality studies. His work focuses on the intersection of engineering, geophysics, and sustainability, contributing to the application of advanced technologies to solve energy and environmental challenges in the region.

[ResearchGate](https://www.researchgate.net/profile/Carlos-Pocasangre-Jimenez)

[LinkedIn](https://www.linkedin.com/in/carlos-pocasangre-b407905b/)
